...
const QuizOver = React.forwardRef((props,ref ) => {
    ...
    const hash = 'dd11491a59f1c8fcac73ee60a2f7f53f'
    ...
    const decision = score >=  averageGrade ?(
        ...
        <Fragment>
        <div className="stepsBtnContainer">
            <p className = "failureMsg"> Vous avez Echouée</p>
    ...
    const questionAnwser = score >= averageGrade ? (asked.map(question => {
        return(
            <tr key = {question.id}>
    ...
    <div className= "modalBody">
       ...
       <h3>Plus d'Info</h3>
       {
           ...
           characterInfos.data.results[0].urls.map( (url , index)=> {
            ...
            >
                {capitalizaFirstLetter(url.type)}
            </a>
        })
       }
       </div>
    ...
    return (
       ...
       {decision}
        <hr/>
        <p> Les reponses au Questions Posées :</p>
